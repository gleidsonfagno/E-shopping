    ...
    <section className="max-w-7xl mx-auto my-10">
      <main className="bg-[#B9F8CF]  rounded-3xl flex flex-col max-md:gap-20 md:flex-row p-20 items-center justify-between  px-4 md:px-16 lg:px-24 xl:px-32">
        <div className="flex flex-col items-center md:items-start">
          ...
          >
            <span className="bg-green-600 text-xs px-3 py-1 text-amber-50 rounded-full">
              NOTÍCIA
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl leading-[1.2] my-3 font-medium bg-gradient-to-r from-slate-600 to-[#236b02] bg-clip-text text-transparent max-w-xs  sm:max-w-md">
          ...
          <div className="flex items-center gap-4 mt-8 text-sm">
            <button
              ...
              className="bg-green-600 uppercase text-white text-sm py-2.5 px-7 sm:py-5 sm:px-12  rounded-md hover:bg-green-700 hover:scale-103 active:scale-95 transition"
            >
              Ver ofertas
            </button>
          </div>
